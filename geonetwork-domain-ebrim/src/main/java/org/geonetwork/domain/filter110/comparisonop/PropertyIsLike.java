...
public class PropertyIsLike extends ComparisonOps {
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((escapeChar == null) ? 0 : escapeChar.hashCode());
		result = prime * result + ((literal == null) ? 0 : literal.hashCode());
		result = prime * result
				+ ((propertyName == null) ? 0 : propertyName.hashCode());
		result = prime * result
				+ ((singleChar == null) ? 0 : singleChar.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (escapeChar == null) {
			if (other.escapeChar != null)
				return false;
		} else if (!escapeChar.equals(other.escapeChar))
			return false;
		if (literal == null) {
		...
		if (propertyName == null) {
			...
			return false;
		if (singleChar == null) {
			if (other.singleChar != null)
				return false;
		} else if (!singleChar.equals(other.singleChar))
			return false;
		if (wildCard == null) {
