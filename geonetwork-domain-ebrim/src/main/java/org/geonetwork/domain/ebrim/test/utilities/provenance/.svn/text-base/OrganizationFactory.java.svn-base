...
public class OrganizationFactory {
	...
	public synchronized static Organization create() {
		...
		o.setHome(new URI("http://organizationhome"));
		o.setId(new URN("urn:organization-urn"));
		o.setLid(new URN("urn:organization-lid"));
		InternationalString name = InternationalStringFactory.create();
		o.setName(name);

		o.setObjectType(new URI("http://organization-objecttype"));

		o.setParent(new URI("http://parent-organization"));

		o.setPrimaryContact(new URI("http://primaryContact"));
		...
		o.setStatus(new URI("http://organization-status"));
