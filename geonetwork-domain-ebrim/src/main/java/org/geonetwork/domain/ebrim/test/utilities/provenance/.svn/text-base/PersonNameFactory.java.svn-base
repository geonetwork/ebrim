...
public class PersonNameFactory {
	...
	public synchronized static PersonName create() {
		PersonName o = new PersonName();

		o.setFirstName(new ShortName("firstName"));
		o.setLastName(new ShortName("lastName"));
		o.setMiddleName(new ShortName("middleName"));
