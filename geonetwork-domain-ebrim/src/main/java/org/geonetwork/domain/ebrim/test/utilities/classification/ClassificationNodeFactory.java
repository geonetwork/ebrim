...
public class ClassificationNodeFactory {

	public synchronized static ClassificationNode create() {

		ClassificationNode o = new ClassificationNode();

		o.setCode(new LongName("classificationNode-code"));
		o.setPath("classificationNode-path");
		o.setParent(new URI("http://classificationNode-parent"));
