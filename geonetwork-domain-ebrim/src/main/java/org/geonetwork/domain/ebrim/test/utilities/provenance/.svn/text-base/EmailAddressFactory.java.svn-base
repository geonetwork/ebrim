...
/**
 * 
 * factory to generate a EmailAddress for testpurposes
 * 
 */
public class EmailAddressFactory {

	public synchronized static EmailAddress create() {
		EmailAddress o = new EmailAddress();

		o.setAddress(new ShortName("email@example.org"));
		o.setType(new String32("email-address-type"));
