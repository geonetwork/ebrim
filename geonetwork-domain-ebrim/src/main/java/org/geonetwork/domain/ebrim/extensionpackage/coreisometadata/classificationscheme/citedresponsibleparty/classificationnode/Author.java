 ...
 *
 */
public class Author extends ClassificationNode {
	...
	public Author() {
		...
		this.setCode(new LongName("author"));
		this.setId(new URN("urn:ogc:def:ebRIM-ClassificationNode:CitedResponsibleParty:author"));

		LocalizedString localizedName = new LocalizedString();
		localizedName.setValue("author");
		...
		localizedDescription.setValue("party who authored the resource");
