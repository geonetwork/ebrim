...
public class VersionInfoFactory {
	...
	public synchronized static VersionInfo create() {
		VersionInfo o = new VersionInfo();
		o.setComment(new LongName("versioninfo-comment"));
		o.setVersionName(new String16("versioninfo-name"));
		return o;
	}
}
