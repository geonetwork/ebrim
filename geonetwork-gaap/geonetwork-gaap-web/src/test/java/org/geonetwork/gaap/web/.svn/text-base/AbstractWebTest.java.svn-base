...
public abstract class AbstractWebTest extends AbstractTransactionalSpringContextTests {
    ...
    protected String[] getConfigLocations() {
        return new String[]{"applicationContext-gn-web-gaap-test.xml", "applicationContext-gn-services-gaap.xml",
                "applicationContext-gn-persistence-gaap.xml"};
    }
