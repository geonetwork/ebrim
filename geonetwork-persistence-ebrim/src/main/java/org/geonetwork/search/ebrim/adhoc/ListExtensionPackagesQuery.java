 ...
 * @author Jose
 */
public class ListExtensionPackagesQuery extends AdhocQuerySearch {
    private static final String QUERY_IDENTIFIER = "urn:ogc:def:ebRIM-Query:OGC:listExtensionPackages";
    ...
    public List<? extends RegistryObject> query(Map<String, String> parameters) throws SearchEngineException {
        return coreDao.loadAllRegistryPackage();
    }
